...
// internal import
import shopImage from '../../assets/images/erik-mclean-czMeCTUJe58-unsplash.jpg';
        ...
        <Root>
            ...
            <Main>
                <MainText>
                    ...
                    <Button sx={{ marginTop: '10px'}} component={Link} to={myAuth === 'true' ? "/shop" : "/auth"} variant='contained'>It's time to duel☠</Button>
                </MainText>
            </Main>
        </Root>
    )
